...
import { fetcher, tmdbGetAPI } from '../config';
...
const MoviePageV2 = () => {
    ...
    const [url, setUrl] = useState(tmdbGetAPI.getMovieList("popular", currentPage));
    ...
    return (
        <div>
            ...
            <div className="mt-10 text-center">
                ...
                className={`${isReachingEnd ? "bg-slate-400 cursor-default" : ""}`}>Loadmore</Button>
            </div>
